  ...
  context 'authenticated' do
    describe 'valid current password' do
      ...
      it 'returns no errors' do
        expect(result['data']['resetPassword']['errors']).to be_empty
      end
    end
    ...
    describe 'invalid current password' do
      ...
      it 'can\'t reset the password' do
        expect(result['data']['resetPassword']['user']).to be_nil
      end

      it 'returns errors' do
        expect(result['data']['resetPassword']['errors']).to_not be_empty
      end
    end
  end
