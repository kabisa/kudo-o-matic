$(document).ready(function () {
    ...
    var tenant = $filterContent.data('tenant');
    ...
    $myTransactions.click(function () {
        ...
        if ($myTransactions.hasClass('is-active')) {
            ...
            $.ajax({
                type:'GET',
                url: "/" + tenant + "/transactions.js?filter=mine", complete: function (result) {
    ...
    $sendTransactions.click(function () {
        ...
        if ($sendTransactions.hasClass('is-active')) {
            ...
            $.ajax({
                type: 'GET',
                url: "/" + tenant + "/transactions.js?filter=send", complete: function (result) {
                    $ajaxpreloader.removeClass('show-preloader');
                }, success: function () {
    ...
    $receivedTransactions.click(function () {
        ...
        if ($receivedTransactions.hasClass('is-active')) {
            ...
            $.ajax({
                type: 'GET',
                url: "/" + tenant + "/transactions.js?filter=received", complete: function (result) {
                    $ajaxpreloader.removeClass('show-preloader');
                }, success: function () {
    ...
    function deleteFilter() {
        $.ajax({
            type:'GET',
            url: "/" + tenant + "/transactions.js?filter=all", complete: function (result) {
                $ajaxpreloader.removeClass('show-preloader');
            }, success: function () {
